import { invalidateQuery, type RpcClient, setQueryData } from "@blitzjs/rpc";
...
export const fpInvalidateQuery = <TInput, TResult, T extends AsyncFunc>(
  resolver: T | Resolver<TInput, TResult> | RpcClient<TInput, TResult>,
  params?: TInput,
): Task<void> =>
() => invalidateQuery(resolver, params);

export const fpSetQueryData = <TInput, TResult, T extends AsyncFunc>(
  resolver: T | Resolver<TInput, TResult> | RpcClient<TInput, TResult>,
  params: TInput,
