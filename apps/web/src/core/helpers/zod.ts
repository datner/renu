...
export const Option = <T extends z.ZodTypeAny>(schema: T) => z.discriminatedUnion("_tag", [None, Some(schema)]);
...
export const Json: z.ZodType<Prisma.JsonValue> = z.lazy(() => z.union([Primitives, z.array(Json), z.record(Json)]));
