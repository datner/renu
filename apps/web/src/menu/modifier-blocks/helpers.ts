...
import { chainNullableK, getOrElse, getOrElseW } from "fp-ts/Option";
...
export const getLabel = <C extends WithContent>(o: C) => (locale: Locale) =>
  pipe(
    o.content,
...
export const getDescription = <C extends WithContent>(o: C) => (locale: Locale) =>
  pipe(
    o.content,
    findFirst((c) => c.locale === locale),
