...
export type StatusSuccess = S.Infer<typeof StatusSuccess>
...
export type StatusError = S.Infer<typeof StatusError>
...
export type StatusUnexpected = S.Infer<typeof StatusUnexpected>

export const GetStatusResponse = S.union(StatusSuccess, StatusError, StatusUnexpected)
export type GetStatusResponse = S.Infer<typeof GetStatusResponse>
