...
export interface StatusSuccess extends S.Infer<typeof StatusSuccess> {}
...
export interface StatusError extends S.Infer<typeof StatusError> {}
...
export interface StatusUnexpected extends S.Infer<typeof StatusUnexpected> {}
